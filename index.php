...
// Struttura dati array multistrutturale delle domande e risposte di Google. Ogni elemento dell'array (nome = "$faqs") è a sua volta un array di tipo associativo composto dal primo elemento, la cui chiave è "question" ed il valore la domanda in questione, e dal secondo elemento, la cui chiave è "answer" e il valore è un ulteriore array di tipo numerico composto da elementi che rappresentono i vari paragrafi che compongono la risposta. Questa scomposizione è volta a facilitare la rappresentazione del testo su una pagina html in modo da avere più paragrafi da rappresentare per una facile lettura e limitare l'uso di tag html all'interno della struttura dati php. Nonostante ciò non ho potuto evitare ad assegnare tag per la rappresentazione di una lista in uno dei paragrafi delle risposte
